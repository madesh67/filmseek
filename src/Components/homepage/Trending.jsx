...
const trending = () => {
    ...
    const fetchtrending = async () => {
      ...
      try {
        const res = await fetch(
          `https://api.themoviedb.org/3/trending/${type}/day?api_key=${import.meta.env.VITE_TMDB_API_KEY}&language=en-US&page=1`
        );
  ...
  return (
    <section className="trending-section" id="trending-section">
      <p className="trending-description">trending movies and TV Shows</p>
